...
interface FeedbackSuccessStepProps {
	onAnotherFeedbackRequested: () => void;
}

export function FeedbackSuccessStep({ onAnotherFeedbackRequested }: FeedbackSuccessStepProps){
	return (
		<>
			<header>
				<CloseButton />
			...
			<div className="flex flex-col items-center py-10 w-[304px]">
				...
				<button
					onClick={onAnotherFeedbackRequested} 
